import ArticlesTitle from './shared/ArticlesTitle';
import BtnLoadMore from './shared/BtnLoadMore';
const articlesList = () => {
  return <div className="articles-list section">
          <div className="tcl-container">
            {/* Main Title */}
            <ArticlesTitle title="News List" viewMore={true} />
            {/* End Main Title */}
            {/* End Row News List */}
